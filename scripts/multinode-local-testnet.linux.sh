...
cat $HOME/.mantrachain/validator1/config/genesis.json | jq '.app_state["mint"]["params"]["mint_denom"]="ustake"' > $HOME/.mantrachain/validator1/config/tmp_genesis.json && mv $HOME/.mantrachain/validator1/config/tmp_genesis.json $HOME/.mantrachain/validator1/config/genesis.json
...
cat $HOME/.mantrachain/validator1/config/genesis.json | jq '.app_state["gov"]["deposit_params"]["min_deposit"][0]["denom"]="ustake"' > $HOME/.mantrachain/validator1/config/tmp_genesis.json && mv $HOME/.mantrachain/validator1/config/tmp_genesis.json $HOME/.mantrachain/validator1/config/genesis.json
...
echo "validator1"
sed -i -E 's|enabled-unsafe-cors = false|enabled-unsafe-cors = true|g' $HOME/.mantrachain/validator1/config/app.toml
sed -i -E 's|enable-unsafe-cors = false|enable-unsafe-cors = true|g' $HOME/.mantrachain/validator1/config/app.toml
sed -i -E '1,/enable = false/s|enable = false|enable = true|g' $HOME/.mantrachain/validator1/config/app.toml
sed -i -E 's|minimum-gas-prices = \"\"|minimum-gas-prices = \"0.0001ustake\"|g' $HOME/.mantrachain/validator1/config/app.toml

echo "validator2"
sed -i -E 's|enabled-unsafe-cors = false|enabled-unsafe-cors = true|g' $HOME/.mantrachain/validator2/config/app.toml
sed -i -E 's|enable-unsafe-cors = false|enable-unsafe-cors = true|g' $HOME/.mantrachain/validator2/config/app.toml
sed -i -E '1,/enable = false/s|enable = false|enable = true|g' $HOME/.mantrachain/validator2/config/app.toml
sed -i -E 's|minimum-gas-prices = \"\"|minimum-gas-prices = \"0.0001ustake\"|g' $HOME/.mantrachain/validator2/config/app.toml
sed -i -E 's|tcp://0.0.0.0:1317|tcp://0.0.0.0:1316|g' $HOME/.mantrachain/validator2/config/app.toml
sed -i -E 's|0.0.0.0:9090|0.0.0.0:9088|g' $HOME/.mantrachain/validator2/config/app.toml
sed -i -E 's|0.0.0.0:9091|0.0.0.0:9089|g' $HOME/.mantrachain/validator2/config/app.toml

echo "validator3"
sed -i -E 's|enabled-unsafe-cors = false|enabled-unsafe-cors = true|g' $HOME/.mantrachain/validator3/config/app.toml
sed -i -E 's|enable-unsafe-cors = false|enable-unsafe-cors = true|g' $HOME/.mantrachain/validator3/config/app.toml
sed -i -E '1,/enable = false/s|enable = false|enable = true|g' $HOME/.mantrachain/validator3/config/app.toml
sed -i -E 's|minimum-gas-prices = \"\"|minimum-gas-prices = \"0.0001ustake\"|g' $HOME/.mantrachain/validator3/config/app.toml
sed -i -E 's|tcp://0.0.0.0:1317|tcp://0.0.0.0:1315|g' $HOME/.mantrachain/validator3/config/app.toml
sed -i -E 's|0.0.0.0:9090|0.0.0.0:9086|g' $HOME/.mantrachain/validator3/config/app.toml
sed -i -E 's|0.0.0.0:9091|0.0.0.0:9087|g' $HOME/.mantrachain/validator3/config/app.toml

echo "change config.toml values"

echo "validator1"
sed -i -E 's|allow_duplicate_ip = false|allow_duplicate_ip = true|g' $HOME/.mantrachain/validator1/config/config.toml
sed -i -E 's|cors_allowed_origins = \[\]|cors_allowed_origins = \[\"*\"\]|g' $HOME/.mantrachain/validator1/config/config.toml
echo "validator2"
sed -i -E 's|cors_allowed_origins = \[\]|cors_allowed_origins = \[\"*\"\]|g' $HOME/.mantrachain/validator2/config/config.toml
sed -i -E 's|tcp://127.0.0.1:26658|tcp://127.0.0.1:26655|g' $HOME/.mantrachain/validator2/config/config.toml
sed -i -E 's|tcp://127.0.0.1:26657|tcp://127.0.0.1:26654|g' $HOME/.mantrachain/validator2/config/config.toml
sed -i -E 's|tcp://0.0.0.0:26656|tcp://0.0.0.0:26653|g' $HOME/.mantrachain/validator2/config/config.toml
sed -i -E 's|allow_duplicate_ip = false|allow_duplicate_ip = true|g' $HOME/.mantrachain/validator2/config/config.toml
echo "validator3"
sed -i -E 's|cors_allowed_origins = \[\]|cors_allowed_origins = \[\"*\"\]|g' $HOME/.mantrachain/validator3/config/config.toml
sed -i -E 's|tcp://127.0.0.1:26658|tcp://127.0.0.1:26652|g' $HOME/.mantrachain/validator3/config/config.toml
sed -i -E 's|tcp://127.0.0.1:26657|tcp://127.0.0.1:26651|g' $HOME/.mantrachain/validator3/config/config.toml
sed -i -E 's|tcp://0.0.0.0:26656|tcp://0.0.0.0:26650|g' $HOME/.mantrachain/validator3/config/config.toml
sed -i -E 's|allow_duplicate_ip = false|allow_duplicate_ip = true|g' $HOME/.mantrachain/validator3/config/config.toml

echo "change client.toml values"

echo "validator1"
sed -i -E 's|chain-id = \"\"|chain-id = \"mantrachain\"|g' $HOME/.mantrachain/validator1/config/client.toml
echo "validator2"
sed -i -E 's|chain-id = \"\"|chain-id = \"mantrachain\"|g' $HOME/.mantrachain/validator2/config/client.toml
sed -i -E 's|26657|26654|g' $HOME/.mantrachain/validator2/config/client.toml
echo "validator3"
sed -i -E 's|chain-id = \"\"|chain-id = \"mantrachain\"|g' $HOME/.mantrachain/validator3/config/client.toml
sed -i -E 's|26657|26651|g' $HOME/.mantrachain/validator3/config/client.toml
...
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$(./build/mantrachaind tendermint show-node-id --home=$HOME/.mantrachain/validator1)@localhost:26656\"|g" $HOME/.mantrachain/validator2/config/config.toml
sed -i -E "s|persistent_peers = \"\"|persistent_peers = \"$(./build/mantrachaind tendermint show-node-id --home=$HOME/.mantrachain/validator1)@localhost:26656\"|g" $HOME/.mantrachain/validator3/config/config.toml
