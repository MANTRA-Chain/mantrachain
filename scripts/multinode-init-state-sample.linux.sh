...
./build/mantrachaind tx token create-nft-collection '{"id":"id1","name":"collection1","description":"collection1","category":"music","url":"http://xxx.yyy","images":[{"type":"main","url":"http://xxx.zzz"}]}' --chain-id mantrachain --from validator1 --keyring-backend test --gas auto --gas-adjustment 1.3 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes

sleep 5

cecho "GREEN" "mint first nft collection nfts"
./build/mantrachaind tx token mint-nfts '{"nfts":[{"id":"id1","title":"nft1","description":"nft1","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id2","title":"nft2","description":"nft2","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id3","title":"nft3","description":"nft3","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id4","title":"nft4","description":"nft4","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id5","title":"nft5","description":"nft5","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id6","title":"nft6","description":"nft6","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id7","title":"nft7","description":"nft7","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id8","title":"nft8","description":"nft8","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id9","title":"nft9","description":"nft9","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]},{"id":"id10","title":"nft10","description":"nft10","url":"http://xxx.yyy","images":[{"type":"x","url":"http://xxx.zzz"}]}]}' --collection-creator $VALIDATOR1 --collection-id id1 --chain-id mantrachain --from validator1 --keyring-backend test --gas auto --gas-adjustment 1.3 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes

sleep 5

cecho "GREEN" "create second nft collection"
./build/mantrachaind tx token create-nft-collection '{"id":"id2","name":"collection2","description":"collection2","category":"music","url":"http://xxx.yyy","images":[{"type":"main","url":"http://xxx.zzz"}]}' --chain-id mantrachain --from validator1 --keyring-backend test --gas auto --gas-adjustment 1.3 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes
...
./build/mantrachaind tx marketplace register-marketplace '{"id":"id1","name":"marketplace1","description":"marketplace1","url":"http://xxx.yyy"}' --chain-id mantrachain --from $VALIDATOR1 --keyring-backend test --gas auto --gas-adjustment 1.3 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes

sleep 5

MARKETPLACE=$(echo $(./build/mantrachaind query marketplace address) | cut -d " " -f 2)

cecho "GREEN" "approve all nfts"
./build/mantrachaind tx token approve-all-nfts $MARKETPLACE true --chain-id mantrachain --from validator1 --keyring-backend test --gas auto --gas-adjustment 1.3 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes
...
./build/mantrachaind tx bank send validator1 $ADMIN1 10000000000ustake --keyring-backend=test --home=$HOME/.mantrachain/validator1 --chain-id=mantrachain --gas=auto --gas-adjustment="1.3" --gas-prices="0.0001ustake" --yes
...
./build/mantrachaind tx bank send validator1 $BRIDGE1 10000000000ustake --keyring-backend=test --home=$HOME/.mantrachain/validator1 --chain-id=mantrachain --gas=auto --gas-adjustment="1.3" --gas-prices="0.0001ustake" --yes
...
./build/mantrachaind tx bridge register-bridge "$(echo $BRIDGE_JSON)" --chain-id mantrachain --from bridge1 --keyring-backend test --gas auto --gas-adjustment 1.3 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes

sleep 5

RECIPIENT1=$(./build/mantrachaind keys show recipient1 -a --keyring-backend=test --home=$HOME/.mantrachain/validator1)
MINT_JSON=$(echo '{"receiver":"{address}","amount":100,"tx_hash":"123"}' | sed -e "s/{address}/$RECIPIENT1/g")
...
FIRST_NFT_COLLECTION=$(echo '{"initially_nft_collection_owner_nfts_for_sale":true,"initially_nft_collection_owner_nfts_min_price":"10wusdc","initially_nfts_vault_lock_percentage":"50","cw20_contract_address":{address}}' | sed -e "s/{address}/$CW20_CONTRACT_ADDRESS/g")
