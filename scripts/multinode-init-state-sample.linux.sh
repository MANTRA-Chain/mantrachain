...
./scripts/multinode-local-testnet.linux.sh
...
then
  ...
  ./build/mantrachaind tx token approve-all-nfts $MARKETPLACE true --chain-id $CHAINID --from validator1 --keyring-backend test --gas auto --gas-adjustment 1.4 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes
...
./build/mantrachaind tx bridge create-cw-20-contract 0 "1" "./contracts/artifacts/v1/cw20_base-aarch64.wasm" --from admin1 --chain-id $CHAINID --keyring-backend test --gas=auto --gas-adjustment="1.3" --gas-prices="0.0001ustake" --home $HOME/.mantrachain/validator1 --yes
...
./build/mantrachaind tx bridge register-bridge "$(echo $BRIDGE_JSON)" --chain-id $CHAINID --from bridge1 --keyring-backend test --gas auto --gas-adjustment 1.4 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes
...
then
  ...
  ./build/mantrachaind tx bridge mint "$(echo $MINT_JSON)" --chain-id $CHAINID --from bridge1 --keyring-backend test --gas auto --bridge-creator $BRIDGE1 --bridge-id id1 --gas auto --gas-adjustment 1.4 --gas-prices 0.0001ustake --home $HOME/.mantrachain/validator1 --yes
fi
