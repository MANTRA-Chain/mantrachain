...
func CustomMessageDecorator(bank *bankkeeper.BaseKeeper, coinFactory *coinfactorykeeper.Keeper) func(wasmkeeper.Messenger) wasmkeeper.Messenger {
...
func (m *CustomMessenger) createDenom(ctx sdk.Context, contractAddr sdk.AccAddress, createDenom *bindings.CreateDenom) ([]sdk.Event, [][]byte, error) {
	err := PerformCreateDenom(m.coinFactory, m.bank, ctx, contractAddr, createDenom)
	if err != nil {
...
func PerformCreateDenom(f *coinfactorykeeper.Keeper, b *bankkeeper.BaseKeeper, ctx sdk.Context, contractAddr sdk.AccAddress, createDenom *bindings.CreateDenom) error {
	if createDenom == nil {
	...
	msgCreateDenom := coinfactorytypes.NewMsgCreateDenom(contractAddr.String(), createDenom.Subdenom)
...
func (m *CustomMessenger) mintTokens(ctx sdk.Context, contractAddr sdk.AccAddress, mint *bindings.MintTokens) ([]sdk.Event, [][]byte, error) {
	err := PerformMint(m.coinFactory, m.bank, ctx, contractAddr, mint)
	if err != nil {
...
func PerformMint(f *coinfactorykeeper.Keeper, b *bankkeeper.BaseKeeper, ctx sdk.Context, contractAddr sdk.AccAddress, mint *bindings.MintTokens) error {
	if mint == nil {
...
func (m *CustomMessenger) changeAdmin(ctx sdk.Context, contractAddr sdk.AccAddress, changeAdmin *bindings.ChangeAdmin) ([]sdk.Event, [][]byte, error) {
	err := ChangeAdmin(m.coinFactory, ctx, contractAddr, changeAdmin)
	if err != nil {
...
func ChangeAdmin(f *coinfactorykeeper.Keeper, ctx sdk.Context, contractAddr sdk.AccAddress, changeAdmin *bindings.ChangeAdmin) error {
	if changeAdmin == nil {
	...
	changeAdminMsg := coinfactorytypes.NewMsgChangeAdmin(contractAddr.String(), changeAdmin.Denom, newAdminAddr.String())
...
func (m *CustomMessenger) burnTokens(ctx sdk.Context, contractAddr sdk.AccAddress, burn *bindings.BurnTokens) ([]sdk.Event, [][]byte, error) {
	err := PerformBurn(m.coinFactory, ctx, contractAddr, burn)
	if err != nil {
...
func PerformBurn(f *coinfactorykeeper.Keeper, ctx sdk.Context, contractAddr sdk.AccAddress, burn *bindings.BurnTokens) error {
	if burn == nil {
		return wasmvmtypes.InvalidRequest{Err: "burn token null mint"}
	}

	coin := sdk.Coin{Denom: burn.Denom, Amount: burn.Amount}
	sdkMsg := coinfactorytypes.NewMsgBurn(contractAddr.String(), coin)
	if err := sdkMsg.ValidateBasic(); err != nil {
		return err
	}
...
func GetFullDenom(contract string, subDenom string) (string, error) {
	...
	fullDenom, err := coinfactorytypes.GetTokenDenom(contract, subDenom)
	if err != nil {
