...
replace (
	...
	github.com/cometbft/cometbft-db => github.com/mmsqe/cometbft-db v0.0.0-20260828021342-d8571fb80232
	github.com/cosmos/cosmos-db => github.com/mmsqe/cosmos-db v0.0.0-20260827100026-4894d5cb2dc1
