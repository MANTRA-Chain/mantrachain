...
replace (
	// another hack
	cosmossdk.io/core => github.com/osmosis-labs/cosmos-sdk/core v0.8.1-0.20240909100828-a40c83ee7722
	// Replace the store
...
require (
	...
	github.com/osmosis-labs/osmosis/v26 v26.0.0-20240910124511-f607ea9a960b
