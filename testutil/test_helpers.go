...
var DefaultConsensusParams = &cbproto.ConsensusParams{
	Block: &cbproto.BlockParams{
		MaxBytes: 200000,
		MaxGas:   2000000,
	},
	Evidence: &cbproto.EvidenceParams{
		MaxAgeNumBlocks: 302400,
		MaxAgeDuration:  504 * time.Hour, // 3 weeks is the max duration
		MaxBytes:        10000,
	},
	Validator: &cbproto.ValidatorParams{
		PubKeyTypes: []string{
...
func MakeTestEncodingConfig() params.EncodingConfig {
	return chain.MakeEncodingConfig()
}
...
func setup(withGenesis bool, invCheckPeriod uint) (*chain.App, chain.GenesisState) {
	...
	if withGenesis {
		genesisState := chain.NewDefaultGenesisState(encCdc.Marshaler)
...
func SetupWithGenesisValSet(t *testing.T, valSet *cbtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *chain.App {
	...
	app.Commit()
	app.BeginBlock(abci.RequestBeginBlock{Header: cbproto.Header{
...
func SetupWithGenesisAccounts(genAccs []authtypes.GenesisAccount, balances ...banktypes.Balance) *chain.App {
	...
	app.Commit()
	app.BeginBlock(abci.RequestBeginBlock{Header: cbproto.Header{Height: app.LastBlockHeight() + 1}})
...
func AddTestAddrsFromPubKeys(app *chain.App, ctx sdk.Context, pubKeys []cryptotypes.PubKey, accAmt sdk.Int) {
...
func AddTestAddrs(app *chain.App, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createRandomAccounts)
}

// AddTestAddrs constructs and returns accNum amount of accounts with an
// initial balance of accAmt in random order
func AddTestAddrsIncremental(app *chain.App, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, createIncrementalAccounts)
}

func addTestAddrs(app *chain.App, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
...
func CheckBalance(t *testing.T, app *chain.App, addr sdk.AccAddress, balances sdk.Coins) {
	ctxCheck := app.BaseApp.NewContext(true, cbproto.Header{})
