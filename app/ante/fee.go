...
func NewDeductFeeDecorator(ak AccountKeeper, bk bankkeeper.Keeper, fk FeegrantKeeper, tfc authante.TxFeeChecker) DeductFeeDecorator {
	if tfc == nil {
...
func DeductFees(bankKeeper bankkeeper.Keeper, ctx sdk.Context, acc sdk.AccountI, fees sdk.Coins) error {
	if !fees.IsValid() {
