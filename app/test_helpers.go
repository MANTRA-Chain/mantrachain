...
func setup(tb testing.TB, chainID string, withGenesis bool, invCheckPeriod uint, opts ...wasmkeeper.Option) (*App, GenesisState) {
	...
	app := New(log.NewNopLogger(), db, true, appOptions, opts,
...
func NewWasmAppWithCustomOptions(t *testing.T, isCheckTx bool, options SetupOptions) *App {
	...
	app := New(options.Logger, options.DB, true, options.AppOpts, options.WasmOpts)
...
func NewTestNetworkFixture() network.TestFixture {
	...
	app := New(log.NewNopLogger(), dbm.NewMemDB(), true, simtestutil.NewAppOptionsWithFlagHome(dir), emptyWasmOptions)
