...
func MakeEncodingConfig(tb testing.TB) params.EncodingConfig {
	...
	tempApp := New(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simtestutil.NewAppOptionsWithFlagHome(tb.TempDir()), []wasmkeeper.Option{}, GetMANTRAEVMChainId(), NoOpEvmAppOptions)
