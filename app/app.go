...
import (
	...
	"github.com/MANTRA-Chain/mantrachain/v7/app/upgrades/v7rc5"
...
var maccPerms = map[string][]string{
	...
	// upgrade module
	v7rc5.UpgradeName: {authtypes.Minter, authtypes.Burner},
}

var Upgrades = []upgrades.Upgrade{v7rc5.Upgrade}
