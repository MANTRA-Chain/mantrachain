...
import (
	...
	mwasm "github.com/MANTRA-Finance/aumega/wasmbinding"
	...
	"github.com/MANTRA-Finance/aumega/x/coinfactory"
	...
	"github.com/MANTRA-Finance/aumega/x/did"
	didkeeper "github.com/MANTRA-Finance/aumega/x/did/keeper"
	didtypes "github.com/MANTRA-Finance/aumega/x/did/types"
	"github.com/MANTRA-Finance/aumega/x/farming"
	farmingclient "github.com/MANTRA-Finance/aumega/x/farming/client"
	...
	"github.com/MANTRA-Finance/aumega/x/guard"
	guardkeeper "github.com/MANTRA-Finance/aumega/x/guard/keeper"
	guardtypes "github.com/MANTRA-Finance/aumega/x/guard/types"
	"github.com/MANTRA-Finance/aumega/x/liquidity"
	liquiditykeeper "github.com/MANTRA-Finance/aumega/x/liquidity/keeper"
	liquiditytypes "github.com/MANTRA-Finance/aumega/x/liquidity/types"
	"github.com/MANTRA-Finance/aumega/x/lpfarm"
	lpfarmclient "github.com/MANTRA-Finance/aumega/x/lpfarm/client"
	lpfarmkeeper "github.com/MANTRA-Finance/aumega/x/lpfarm/keeper"
	lpfarmtypes "github.com/MANTRA-Finance/aumega/x/lpfarm/types"
	"github.com/MANTRA-Finance/aumega/x/marketmaker"
	marketmakerclient "github.com/MANTRA-Finance/aumega/x/marketmaker/client"
	marketmakerkeeper "github.com/MANTRA-Finance/aumega/x/marketmaker/keeper"
	marketmakertypes "github.com/MANTRA-Finance/aumega/x/marketmaker/types"
	"github.com/MANTRA-Finance/aumega/x/token"
	tokenkeeper "github.com/MANTRA-Finance/aumega/x/token/keeper"
	tokentypes "github.com/MANTRA-Finance/aumega/x/token/types"

	"github.com/cosmos/cosmos-sdk/x/nft"
	nftkeeper "github.com/cosmos/cosmos-sdk/x/nft/keeper"
	nftmodule "github.com/cosmos/cosmos-sdk/x/nft/module"

	txfeesmodule "github.com/MANTRA-Finance/aumega/x/txfees"
	...
	"github.com/MANTRA-Finance/aumega/docs"
)

const (
	AccountAddressPrefix = "aumega"
	Name                 = "aumega"
...
func New(
...
) *App { // This should run before anything else to make sure the variables are properly initialized
	...
	keys := sdk.NewKVStoreKeys(
		...
		capabilitytypes.StoreKey, group.StoreKey, icacontrollertypes.StoreKey, ibcfeetypes.StoreKey,
	...
	*/
	...
	app.TokenKeeper = *tokenkeeper.NewKeeper(
		appCodec, keys[tokentypes.StoreKey], app.GetSubspace(tokentypes.ModuleName), app.NFTKeeper, &app.GuardKeeper, app.DidKeeper,
	)
