...
var Upgrades = []upgrades.Upgrade{v8_5.Upgrade}
...
func New(
	...
	*/
	...
	transferStack = ibc_middleware.NewMigrateUomIBCModule(transferModule, app.BankKeeper, app.AccountKeeper.AddressCodec())
