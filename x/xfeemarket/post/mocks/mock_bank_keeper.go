...
// AddSupplyOffset provides a mock function with given fields: ctx, denom, offsetAmount
func (_m *BankKeeper) AddSupplyOffset(ctx context.Context, denom string, offsetAmount math.Int) {
	_m.Called(ctx, denom, offsetAmount)
}
...
// GetPaginatedTotalSupplyWithOffsets provides a mock function with given fields: ctx, pagination
func (_m *BankKeeper) GetPaginatedTotalSupplyWithOffsets(ctx context.Context, pagination *query.PageRequest) (cosmos_sdktypes.Coins, *query.PageResponse, error) {
	ret := _m.Called(ctx, pagination)

	if len(ret) == 0 {
		panic("no return value specified for GetPaginatedTotalSupplyWithOffsets")
	}
...
// GetSupplyOffset provides a mock function with given fields: ctx, denom
func (_m *BankKeeper) GetSupplyOffset(ctx context.Context, denom string) math.Int {
	ret := _m.Called(ctx, denom)

	if len(ret) == 0 {
		panic("no return value specified for GetSupplyOffset")
	}

	var r0 math.Int
	if rf, ok := ret.Get(0).(func(context.Context, string) math.Int); ok {
		r0 = rf(ctx, denom)
	} else {
...
// GetSupplyWithOffset provides a mock function with given fields: ctx, denom
func (_m *BankKeeper) GetSupplyWithOffset(ctx context.Context, denom string) cosmos_sdktypes.Coin {
	ret := _m.Called(ctx, denom)

	if len(ret) == 0 {
		panic("no return value specified for GetSupplyWithOffset")
	}
...
// IterateTotalSupplyWithOffsets provides a mock function with given fields: ctx, cb
func (_m *BankKeeper) IterateTotalSupplyWithOffsets(ctx context.Context, cb func(cosmos_sdktypes.Coin) bool) {
	_m.Called(ctx, cb)
}
...
// SendCoinsFromModuleToManyAccounts provides a mock function with given fields: ctx, senderModule, recipientAddrs, amts
func (_m *BankKeeper) SendCoinsFromModuleToManyAccounts(ctx context.Context, senderModule string, recipientAddrs []cosmos_sdktypes.AccAddress, amts []cosmos_sdktypes.Coins) error {
	ret := _m.Called(ctx, senderModule, recipientAddrs, amts)

	if len(ret) == 0 {
		panic("no return value specified for SendCoinsFromModuleToManyAccounts")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []cosmos_sdktypes.AccAddress, []cosmos_sdktypes.Coins) error); ok {
		r0 = rf(ctx, senderModule, recipientAddrs, amts)
	} else {
		r0 = ret.Error(0)
	}
...
// SendManyCoins provides a mock function with given fields: ctx, fromAddr, toAddrs, amts
func (_m *BankKeeper) SendManyCoins(ctx context.Context, fromAddr cosmos_sdktypes.AccAddress, toAddrs []cosmos_sdktypes.AccAddress, amts []cosmos_sdktypes.Coins) error {
	ret := _m.Called(ctx, fromAddr, toAddrs, amts)

	if len(ret) == 0 {
		panic("no return value specified for SendManyCoins")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, cosmos_sdktypes.AccAddress, []cosmos_sdktypes.AccAddress, []cosmos_sdktypes.Coins) error); ok {
		r0 = rf(ctx, fromAddr, toAddrs, amts)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *BankKeeper) SupplyOfWithoutOffset(_a0 context.Context, _a1 *types.QuerySupplyOfWithoutOffsetRequest) (*types.QuerySupplyOfWithoutOffsetResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for SupplyOfWithoutOffset")
	}

	var r0 *types.QuerySupplyOfWithoutOffsetResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QuerySupplyOfWithoutOffsetRequest) (*types.QuerySupplyOfWithoutOffsetResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QuerySupplyOfWithoutOffsetRequest) *types.QuerySupplyOfWithoutOffsetResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QuerySupplyOfWithoutOffsetResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QuerySupplyOfWithoutOffsetRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *BankKeeper) TotalSupplyWithoutOffset(_a0 context.Context, _a1 *types.QueryTotalSupplyWithoutOffsetRequest) (*types.QueryTotalSupplyWithoutOffsetResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for TotalSupplyWithoutOffset")
	}

	var r0 *types.QueryTotalSupplyWithoutOffsetResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryTotalSupplyWithoutOffsetRequest) (*types.QueryTotalSupplyWithoutOffsetResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryTotalSupplyWithoutOffsetRequest) *types.QueryTotalSupplyWithoutOffsetResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryTotalSupplyWithoutOffsetResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryTotalSupplyWithoutOffsetRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
