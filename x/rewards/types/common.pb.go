...
type ProviderPair struct {
	...
	OwedRewards           github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=owed_rewards,json=owedRewards,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"owed_rewards"`
	...
	LastDepositTime       *time.Time                                  `protobuf:"bytes,6,opt,name=last_deposit_time,json=lastDepositTime,proto3,stdtime" json:"last_deposit_time,omitempty"`
}
...
type SnapshotPool struct {
	...
	CoinSupply      cosmossdk_io_math.LegacyDec                 `protobuf:"bytes,2,opt,name=coin_supply,json=coinSupply,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"coin_supply"`
	RewardsPerToken github_com_cosmos_cosmos_sdk_types.DecCoins `protobuf:"bytes,3,rep,name=rewards_per_token,json=rewardsPerToken,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"rewards_per_token"`
}
...
var fileDescriptor_274771e038f60916 = []byte{
	...
	,
}
