...
var (
	...
	ErrInvalidNftCollectionOpened      = sdkerrors.Register(ModuleName, 1124, "nft collection opened provided is invalid")

	ErrInvalidNftId          = sdkerrors.Register(ModuleName, 1125, "nft id provided is invalid")
	ErrInvalidNftTitle       = sdkerrors.Register(ModuleName, 1126, "nft title provided is invalid")
	ErrInvalidNftUrl         = sdkerrors.Register(ModuleName, 1127, "nft url provided is invalid")
	ErrInvalidNftDescription = sdkerrors.Register(ModuleName, 1128, "nft description provided is invalid")
	ErrInvalidNftImage       = sdkerrors.Register(ModuleName, 1129, "nft image provided is invalid")
	ErrInvalidNftLink        = sdkerrors.Register(ModuleName, 1130, "nft link provided is invalid")
	ErrInvalidNftAttribute   = sdkerrors.Register(ModuleName, 1131, "nft attribute provided is invalid")
	ErrInvalidNftsLength     = sdkerrors.Register(ModuleName, 1132, "nfts length provided is invalid")
)
