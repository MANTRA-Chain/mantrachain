...
type Epoch struct {
	...
	Id               int64                                     `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty" yaml:"id"`
	PrevEpochBlock   int64                                     `protobuf:"varint,3,opt,name=prev_epoch_block,json=prevEpochBlock,proto3" json:"prev_epoch_block,omitempty" yaml:"prev_epoch_block"`
	NextEpochBlock   int64                                     `protobuf:"varint,4,opt,name=next_epoch_block,json=nextEpochBlock,proto3" json:"next_epoch_block,omitempty" yaml:"next_epoch_block"`
	BlockStart       int64                                     `protobuf:"varint,5,opt,name=block_start,json=blockStart,proto3" json:"block_start,omitempty" yaml:"block_start"`
	BlockEnd         int64                                     `protobuf:"varint,6,opt,name=block_end,json=blockEnd,proto3" json:"block_end,omitempty" yaml:"block_end"`
	Staked           github_com_cosmos_cosmos_sdk_types.Dec    `protobuf:"bytes,7,opt,name=staked,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"staked" yaml:"staked"`
	Rewards          []github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,8,rep,name=rewards,proto3,casttype=github.com/cosmos/cosmos-sdk/types.Coin" json:"rewards" yaml:"rewards"`
	StartAt          int64                                     `protobuf:"varint,9,opt,name=start_at,json=startAt,proto3" json:"start_at,omitempty" yaml:"start_at"`
	EndAt            int64                                     `protobuf:"varint,10,opt,name=end_at,json=endAt,proto3" json:"end_at,omitempty" yaml:"end_at"`
	StakingChain     string                                    `protobuf:"bytes,11,opt,name=staking_chain,json=stakingChain,proto3" json:"staking_chain,omitempty" yaml:"staking_chain"`
	StakingValidator string                                    `protobuf:"bytes,12,opt,name=staking_validator,json=stakingValidator,proto3" json:"staking_validator,omitempty" yaml:"staking_validator"`
}
...
var fileDescriptor_fdf393959b44d469 = []byte{
	...
	,
}
