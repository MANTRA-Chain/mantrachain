...
import (
	...
	"github.com/LimeChain/mantrachain/x/marketmaker/keeper"
	"github.com/LimeChain/mantrachain/x/marketmaker/types"
)
...
func NewMarketMakerProposalHandler(k keeper.Keeper) govv1beta1.Handler {
	return func(ctx sdk.Context, content govv1beta1.Content) error {
		...
		default:
			return errors.Wrapf(sdkerrors.ErrUnknownRequest, "unrecognized market maker proposal content type: %T", c)
		}
	}
}
