...
type GenesisState struct {
	...
	PlanRecords               []PlanRecord               `protobuf:"bytes,3,rep,name=plan_records,json=planRecords,proto3" json:"plan_records"`
	StakingRecords            []StakingRecord            `protobuf:"bytes,4,rep,name=staking_records,json=stakingRecords,proto3" json:"staking_records"`
	QueuedStakingRecords      []QueuedStakingRecord      `protobuf:"bytes,5,rep,name=queued_staking_records,json=queuedStakingRecords,proto3" json:"queued_staking_records"`
	HistoricalRewardsRecords  []HistoricalRewardsRecord  `protobuf:"bytes,6,rep,name=historical_rewards_records,json=historicalRewardsRecords,proto3" json:"historical_rewards_records"`
	OutstandingRewardsRecords []OutstandingRewardsRecord `protobuf:"bytes,7,rep,name=outstanding_rewards_records,json=outstandingRewardsRecords,proto3" json:"outstanding_rewards_records"`
	UnharvestedRewardsRecords []UnharvestedRewardsRecord `protobuf:"bytes,8,rep,name=unharvested_rewards_records,json=unharvestedRewardsRecords,proto3" json:"unharvested_rewards_records"`
	CurrentEpochRecords       []CurrentEpochRecord       `protobuf:"bytes,9,rep,name=current_epoch_records,json=currentEpochRecords,proto3" json:"current_epoch_records"`
	TotalStakingsRecords      []TotalStakingsRecord      `protobuf:"bytes,10,rep,name=total_stakings_records,json=totalStakingsRecords,proto3" json:"total_stakings_records"`
	...
	RewardPoolCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,11,rep,name=reward_pool_coins,json=rewardPoolCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"reward_pool_coins"`
	// last_epoch_time specifies the last executed epoch time of the plans
	LastEpochTime *time.Time `protobuf:"bytes,12,opt,name=last_epoch_time,json=lastEpochTime,proto3,stdtime" json:"last_epoch_time,omitempty"`
...
type PlanRecord struct {
	...
	// this param is needed for import/export validation
	FarmingPoolCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=farming_pool_coins,json=farmingPoolCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"farming_pool_coins"`
}
...
type QueuedStakingRecord struct {
	...
	QueuedStaking    QueuedStaking `protobuf:"bytes,4,opt,name=queued_staking,json=queuedStaking,proto3" json:"queued_staking"`
}
...
type TotalStakingsRecord struct {
	...
	StakingReserveCoins github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,9,rep,name=staking_reserve_coins,json=stakingReserveCoins,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"staking_reserve_coins"`
}
...
type OutstandingRewardsRecord struct {
	StakingCoinDenom   string             `protobuf:"bytes,1,opt,name=staking_coin_denom,json=stakingCoinDenom,proto3" json:"staking_coin_denom,omitempty"`
	OutstandingRewards OutstandingRewards `protobuf:"bytes,2,opt,name=outstanding_rewards,json=outstandingRewards,proto3" json:"outstanding_rewards"`
}
...
type UnharvestedRewardsRecord struct {
	...
	StakingCoinDenom   string             `protobuf:"bytes,2,opt,name=staking_coin_denom,json=stakingCoinDenom,proto3" json:"staking_coin_denom,omitempty"`
	UnharvestedRewards UnharvestedRewards `protobuf:"bytes,3,opt,name=unharvested_rewards,json=unharvestedRewards,proto3" json:"unharvested_rewards"`
}
...
var fileDescriptor_33ad7c0e67606d96 = []byte{
	...
	,
}
