...
func GetCmdQueryClass() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s query %s class <class-id>`, version.AppName, types.ModuleName),
...
func GetCmdQueryClasses() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s query %s classes`, version.AppName, types.ModuleName),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
				return err
...
func GetCmdQueryNFT() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s query %s nft`, version.AppName, types.ModuleName),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
				return err
...
func GetCmdQueryOwner() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s query %s owner <class-id> <nft-id>`, version.AppName, types.ModuleName),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
				return err
...
func GetCmdQueryBalance() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s query %s balance <owner> <class-id>`, version.AppName, types.ModuleName),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
				return err
...
func GetCmdQuerySupply() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf(`$ %s query %s supply <class-id>`, version.AppName, types.ModuleName),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
				return err
