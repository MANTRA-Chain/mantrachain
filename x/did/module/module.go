...
import (
	...
	modulev1 "github.com/MANTRA-Finance/mantrachain/api/mantrachain/did/module/v1"
...
func InvokeSetGuardKeeper(
	...
	if guardKeeper == nil {
		return fmt.Errorf("guard keeper is nil")
	}
	keeper.SetGuardKeeper(k, guardKeeper)
	return nil
}
