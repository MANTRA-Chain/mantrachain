...
# Examples
To create a new token, use the create-denom command from the coinfactory module. The following example uses the address aumega1c584m4lq25h83yp6ag8hh4htjr92d954vklzja from mylocalwallet as the default admin for the new token.

## Creating a token
To create a new token we can use the create-denom command.

```sh
aumegad tx coinfactory create-denom ufoo --keyring-backend=test --from mylocalwallet
```
...
```sh
aumegad tx coinfactory mint 100000000000factory/aumega1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo --keyring-backend=test --from mylocalwallet
```

## Checking Token metadata
To view a token's metadata, use the denom-metadata command in the bank module. The following example queries the metadata for the token factory/aumega1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo:

```sh
aumegad query bank denom-metadata --denom factory/aumega1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo
```

## Check the tokens created by an account
To see a list of tokens created by a specific account, use the denoms-from-creator command in the coinfactory module. The following example shows tokens created by the account aumega1c584m4lq25h83yp6ag8hh4htjr92d954vklzja:

```sh
aumegad query coinfactory denoms-from-creator aumega1c584m4lq25h83yp6ag8hh4htjr92d954vklzja
```
