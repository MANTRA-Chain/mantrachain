...
func (suite *KeeperTestSuite) FindEvent(events []sdk.Event, name string) sdk.Event {
...
func (suite *KeeperTestSuite) ExtractAttributes(event sdk.Event) map[string]string {
