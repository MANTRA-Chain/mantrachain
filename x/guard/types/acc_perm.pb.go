...
type AccPerm struct {
	...
	WhlCurr []string `protobuf:"bytes,2,rep,name=whl_curr,json=whlCurr,proto3" json:"whl_curr,omitempty"`
...
func (m *AccPerm) GetWhlCurr() []string {
	if m != nil {
		return m.WhlCurr
	}
	return nil
...
var fileDescriptor_2b835f05874c3cb9 = []byte{
	...
	0x12, 0x41, 0x52, 0xa4, 0x07, 0x56, 0xa4, 0x57, 0x66, 0xa8, 0x14, 0xc0, 0xc5, 0xee, 0x98, 0x9c,
	0x1c, 0x90, 0x5a, 0x94, 0x2b, 0x24, 0xc0, 0xc5, 0x9c, 0x9c, 0x58, 0x22, 0xc1, 0xa8, 0xc0, 0xa8,
	0xc1, 0x19, 0x04, 0x62, 0x0a, 0x49, 0x72, 0x71, 0x94, 0x67, 0xe4, 0xc4, 0x27, 0x97, 0x16, 0x15,
	0x49, 0x30, 0x29, 0x30, 0x6b, 0x70, 0x06, 0xb1, 0x97, 0x67, 0xe4, 0x38, 0x97, 0x16, 0x15, 0x09,
	0x49, 0x70, 0xb1, 0x27, 0x17, 0xa5, 0x26, 0x96, 0xe4, 0x17, 0x49, 0x30, 0x83, 0x35, 0xc0, 0xb8,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0xef, 0x93, 0x99, 0x9b, 0xea, 0x0c, 0x76, 0x2f,
	0xb2, 0xdb, 0x2b, 0xa0, 0xae, 0x2f, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x3b, 0xdc, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0xa1, 0xc1, 0x92, 0x7a, 0xdf, 0x00, 0x00, 0x00,
}
...
func (m *AccPerm) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.WhlCurr) > 0 {
		for iNdEx := len(m.WhlCurr) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintAccPerm(dAtA, i, uint64(len(m.WhlCurr[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.Cat) > 0 {
		i -= len(m.Cat)
		copy(dAtA[i:], m.Cat)
		i = encodeVarintAccPerm(dAtA, i, uint64(len(m.Cat)))
		i--
		dAtA[i] = 0xa
	}
