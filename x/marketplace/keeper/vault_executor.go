...
func (c *VaultExecutor) UpsertNftStakeAndDelegate(
	...
	return c.vaultKeeper.UpsertNftStakeAndDelegate(c.ctx, marketplaceIndex, collectionIndex, nftIndex, creator, amount, stakingChain, stakingValidator)
}
