...
func (m *MockNFTKeeper) BatchBurn(ctx types.Context, classID string, nftIDs []string) error {
	m.ctrl.T.Helper()
...
func (m *MockNFTKeeper) BatchTransfer(ctx types.Context, classID string, nftIDs []string, receiver types.AccAddress) error {
	m.ctrl.T.Helper()
...
func (m *MockGuardKeeper) CheckNewRestrictedNftsCollection(ctx types.Context, restrictedNftsCollection bool, address string) error {
	m.ctrl.T.Helper()
...
func (m *MockGuardKeeper) CheckRestrictedNftsCollection(ctx types.Context, collectionCreator, collectionId, address string) error {
	m.ctrl.T.Helper()
...
func (m *MockGuardKeeper) GetAccountPrivilegesTokenCollectionCreatorAndCollectionId(ctx types.Context) (string, string) {
	m.ctrl.T.Helper()
...
func (m *MockDidKeeper) CreateNewDidDocument(ctx types.Context, id, controller string) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockDidKeeper) ForceRemoveDidDocumentIfExists(ctx types.Context, id string) (bool, error) {
	m.ctrl.T.Helper()
