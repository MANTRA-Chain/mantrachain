...
var (
	...
	ErrInvalidNftId              = sdkerrors.Register(ModuleName, 1128, "nft id provided is invalid")
	ErrInvalidNftTitle           = sdkerrors.Register(ModuleName, 1129, "nft title provided is invalid")
	ErrInvalidNftUrl             = sdkerrors.Register(ModuleName, 1130, "nft url provided is invalid")
	ErrInvalidNftDescription     = sdkerrors.Register(ModuleName, 1131, "nft description provided is invalid")
	ErrInvalidNftImage           = sdkerrors.Register(ModuleName, 1132, "nft image provided is invalid")
	ErrInvalidNftLink            = sdkerrors.Register(ModuleName, 1133, "nft link provided is invalid")
	ErrInvalidNftAttribute       = sdkerrors.Register(ModuleName, 1134, "nft attribute provided is invalid")
	ErrInvalidNftImagesCount     = sdkerrors.Register(ModuleName, 1135, "nft images count provided is invalid")
