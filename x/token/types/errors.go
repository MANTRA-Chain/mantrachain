...
var (
	...
	ErrInvalidNftId              = errors.Register(ModuleName, 1129, "nft id provided is invalid")
	ErrInvalidNftTitle           = errors.Register(ModuleName, 1130, "nft title provided is invalid")
	ErrInvalidNftUrl             = errors.Register(ModuleName, 1131, "nft url provided is invalid")
	ErrInvalidNftDescription     = errors.Register(ModuleName, 1132, "nft description provided is invalid")
	ErrInvalidNftImage           = errors.Register(ModuleName, 1133, "nft image provided is invalid")
	ErrInvalidNftLink            = errors.Register(ModuleName, 1134, "nft link provided is invalid")
	ErrInvalidNftAttribute       = errors.Register(ModuleName, 1135, "nft attribute provided is invalid")
	ErrInvalidNftImagesCount     = errors.Register(ModuleName, 1136, "nft images count provided is invalid")
	ErrInvalidNftLinksCount      = errors.Register(ModuleName, 1137, "nft links count provided is invalid")
	ErrInvalidNftAttributesCount = errors.Register(ModuleName, 1138, "nft attributes count provided is invalid")
	ErrInvalidNftsCount          = errors.Register(ModuleName, 1139, "nfts count provided is invalid")
	ErrInvalidNft                = errors.Register(ModuleName, 1140, "nfts provided is invalid")
