...
var (
	...
	ErrInvalidCw20MintMinter             = sdkerrors.Register(ModuleName, 1130, "cw20 mint minter is invalid")
	ErrInvalidCw20InitialBalancesAddress = sdkerrors.Register(ModuleName, 1131, "cw20 initial balances address is invalid")
	ErrInvalidCw20InitialBalancesAmount  = sdkerrors.Register(ModuleName, 1132, "cw20 initial balances amount is invalid")
)
