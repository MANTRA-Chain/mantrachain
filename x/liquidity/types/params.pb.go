...
type Params struct {
	...
	SwapFeeRate                  cosmossdk_io_math.LegacyDec              `protobuf:"bytes,12,opt,name=swap_fee_rate,json=swapFeeRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"swap_fee_rate"`
	WithdrawFeeRate              cosmossdk_io_math.LegacyDec              `protobuf:"bytes,13,opt,name=withdraw_fee_rate,json=withdrawFeeRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"withdraw_fee_rate"`
	...
	PairCreatorSwapFeeRatio      cosmossdk_io_math.LegacyDec              `protobuf:"bytes,18,opt,name=pair_creator_swap_fee_ratio,json=pairCreatorSwapFeeRatio,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"pair_creator_swap_fee_ratio"`
}
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_894e1e17127fd385, []int{0}
}
...
func (m *Params) GetDepositExtraGas() uint64 {
	if m != nil {
		return m.DepositExtraGas
	}
	return 0
}

func (m *Params) GetWithdrawExtraGas() uint64 {
	if m != nil {
		return m.WithdrawExtraGas
	}
	return 0
}

func (m *Params) GetOrderExtraGas() uint64 {
	if m != nil {
		return m.OrderExtraGas
	}
	return 0
}
...
func init() {
	proto.RegisterFile("mantrachain/liquidity/v1beta1/params.proto", fileDescriptor_894e1e17127fd385)
}

var fileDescriptor_894e1e17127fd385 = []byte{
	// 837 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.DepositExtraGas != that1.DepositExtraGas {
		return false
	}
	if this.WithdrawExtraGas != that1.WithdrawExtraGas {
		return false
	}
	if this.OrderExtraGas != that1.OrderExtraGas {
		return false
	}
	if this.MaxNumActivePoolsPerPair != that1.MaxNumActivePoolsPerPair {
		return false
	}
	if !this.PairCreatorSwapFeeRatio.Equal(that1.PairCreatorSwapFeeRatio) {
		return false
	}
	return true
}
	...
	for iNdEx < l {
		...
		case 14:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DepositExtraGas |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 15:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WithdrawExtraGas |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 16:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OrderExtraGas |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
