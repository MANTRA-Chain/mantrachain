...
func ExampleMakeOrderBookPairResponse() {
	ob := amm.NewOrderBook(
		newOrder(amm.Sell, utils.ParseDec("15.0"), math.NewInt(10000)),
		newOrder(amm.Sell, utils.ParseDec("13.0"), math.NewInt(10000)),
		newOrder(amm.Sell, utils.ParseDec("10.01"), math.NewInt(10000)),
		newOrder(amm.Sell, utils.ParseDec("10.0"), math.NewInt(10000)),
		newOrder(amm.Buy, utils.ParseDec("10.01"), math.NewInt(10000)),
		newOrder(amm.Buy, utils.ParseDec("10.0"), math.NewInt(10000)),
		newOrder(amm.Buy, utils.ParseDec("9.0"), math.NewInt(10000)),
		newOrder(amm.Buy, utils.ParseDec("3.0"), math.NewInt(10000)),
		newOrder(amm.Buy, utils.ParseDec("0.1"), math.NewInt(10000)),
	)
	ov := ob.MakeView()
	ov.Match()
	tickPrec := 1
...
func ExampleMakeOrderBookPairResponse_pool() {
	pool1 := amm.NewBasicPool(math.NewInt(1050_000000), math.NewInt(1000_000000), math.Int{})
	pool2, err := amm.CreateRangedPool(
		math.NewInt(1000_000000), math.NewInt(1000_000000),
...
func ExampleMakeOrderBookPairResponse_userOrder() {
	pool := amm.NewBasicPool(math.NewInt(895590740832), math.NewInt(675897553075), math.Int{})
	...
	ob.AddOrder(
		newOrder(amm.Buy, utils.ParseDec("1.316"), math.NewInt(111000000)),
		newOrder(amm.Buy, utils.ParseDec("1.32"), math.NewInt(111000000)),
		newOrder(amm.Buy, utils.ParseDec("1.325"), math.NewInt(11000000)),
		newOrder(amm.Buy, utils.ParseDec("1.325"), math.NewInt(111000000)),
		newOrder(amm.Buy, utils.ParseDec("1.325"), math.NewInt(20000000)),
		newOrder(amm.Buy, utils.ParseDec("1.325"), math.NewInt(111000000)),
	)
...
func ExampleMakeOrderBookPairResponse_match() {
	ob := amm.NewOrderBook(
		newOrder(amm.Buy, utils.ParseDec("1.000"), math.NewInt(3000)),
		newOrder(amm.Buy, utils.ParseDec("0.999"), math.NewInt(10000)),
		newOrder(amm.Sell, utils.ParseDec("1.001"), math.NewInt(10000)),
		newOrder(amm.Sell, utils.ParseDec("1.000"), math.NewInt(10000)),
	)
...
func ExampleMakeOrderBookPairResponse_zigzag() {
	ob := amm.NewOrderBook(
		newOrder(amm.Sell, utils.ParseDec("1.002"), math.NewInt(10000)),
		newOrder(amm.Buy, utils.ParseDec("1.001"), math.NewInt(5000)),
		newOrder(amm.Sell, utils.ParseDec("1.000"), math.NewInt(50000)),
		newOrder(amm.Buy, utils.ParseDec("0.999"), math.NewInt(100000)),
	)
	ov := ob.MakeView()
	ov.Match()
...
func ExampleMakeOrderBookPairResponse_edgecase1() {
	basicPool := amm.NewBasicPool(math.NewInt(2603170018), math.NewInt(2731547352), math.Int{})
	rangedPool := amm.NewRangedPool(math.NewInt(9204969), math.NewInt(292104465), math.Int{}, utils.ParseDec("0.95"), utils.ParseDec("1.05"))
...
func ExampleMakeOrderBookPairResponse_edgecase2() {
	ob := amm.NewOrderBook(
		newOrder(amm.Buy, utils.ParseDec("1.001"), math.NewInt(3000)),
		newOrder(amm.Buy, utils.ParseDec("1.000"), math.NewInt(10000)),
		newOrder(amm.Sell, utils.ParseDec("0.999"), math.NewInt(5000)),
		newOrder(amm.Sell, utils.ParseDec("0.998"), math.NewInt(3000)),
		newOrder(amm.Sell, utils.ParseDec("0.997"), math.NewInt(2000)),
	)
...
func ExampleMakeOrderBookPairResponse_edgecase3() {
	ob := amm.NewOrderBook(
		newOrder(amm.Sell, utils.ParseDec("1.001"), math.NewInt(2000)),
		newOrder(amm.Sell, utils.ParseDec("1.000"), math.NewInt(2000)),
		newOrder(amm.Buy, utils.ParseDec("1.000"), math.NewInt(2000)),
		newOrder(amm.Buy, utils.ParseDec("0.999"), math.NewInt(2000)),
	)
...
func ExampleMakeOrderBookPairResponse_priceUnits1() {
	...
	pool := amm.NewBasicPool(math.NewInt(9995_000000), math.NewInt(10000_000000), math.Int{})
	ob.AddOrder(amm.PoolOrders(pool, amm.DefaultOrderer, lowestPrice, highestPrice, 4)...)
...
func ExampleMakeOrderBookPairResponse_priceUnits2() {
	...
	lowestPrice, highestPrice := types.PriceLimits(lastPrice, utils.ParseDec("0.1"), 4)
	pool := amm.NewBasicPool(math.NewInt(9999_000000), math.NewInt(10000_000000), math.Int{})
	ob.AddOrder(amm.PoolOrders(pool, amm.DefaultOrderer, lowestPrice, highestPrice, 4)...)
