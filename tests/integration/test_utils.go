...
import (
	...
	mantraapp "github.com/MANTRA-Chain/mantrachain/v6/app"
...
func MantraAppIniterTempDir() (ibctesting.TestingApp, map[string]json.RawMessage) {
	...
	app = mantraapp.New(
		...
		[]wasmkeeper.Option{},
		mantraapp.MANTRAChainID,
		mantraapp.EvmAppOptions,
	)
...
// MantraAppIniter implements ibctesting.AppIniter for the mantra app
func MantraAppIniter() (ibctesting.TestingApp, map[string]json.RawMessage) {
	app = mantraapp.New(
		log.NewNopLogger(),
		dbm.NewMemDB(),
		nil,
		true,
		simtestutil.NewAppOptionsWithFlagHome(mantraapp.DefaultNodeHome),
		[]wasmkeeper.Option{},
		mantraapp.MANTRAChainID,
		mantraapp.EvmAppOptions,
	)
