...
const (
	Msg_UpdateParams_FullMethodName     = "/mantrachain.marketmaker.v1beta1.Msg/UpdateParams"
	Msg_ApplyMarketMaker_FullMethodName = "/mantrachain.marketmaker.v1beta1.Msg/ApplyMarketMaker"
	Msg_ClaimIncentives_FullMethodName  = "/mantrachain.marketmaker.v1beta1.Msg/ClaimIncentives"
)
...
func (c *msgClient) ApplyMarketMaker(ctx context.Context, in *MsgApplyMarketMaker, opts ...grpc.CallOption) (*MsgApplyMarketMakerResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_ApplyMarketMaker_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimIncentives(ctx context.Context, in *MsgClaimIncentives, opts ...grpc.CallOption) (*MsgClaimIncentivesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_ClaimIncentives_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) ApplyMarketMaker(context.Context, *MsgApplyMarketMaker) (*MsgApplyMarketMakerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ApplyMarketMaker not implemented")
}
func (UnimplementedMsgServer) ClaimIncentives(context.Context, *MsgClaimIncentives) (*MsgClaimIncentivesResponse, error) {
...
func _Msg_ApplyMarketMaker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_ApplyMarketMaker_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ClaimIncentives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_ClaimIncentives_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
