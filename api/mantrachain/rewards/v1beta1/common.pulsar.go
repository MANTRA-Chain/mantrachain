...
var (
	...
	fd_ProviderPair_pair_id                  protoreflect.FieldDescriptor
	fd_ProviderPair_last_claimed_snapshot_id protoreflect.FieldDescriptor
	fd_ProviderPair_owed_rewards             protoreflect.FieldDescriptor
	fd_ProviderPair_balances                 protoreflect.FieldDescriptor
	fd_ProviderPair_pool_id_to_idx           protoreflect.FieldDescriptor
	fd_ProviderPair_last_deposit_time        protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ProviderPair_pair_id = md_ProviderPair.Fields().ByName("pair_id")
	fd_ProviderPair_last_claimed_snapshot_id = md_ProviderPair.Fields().ByName("last_claimed_snapshot_id")
	fd_ProviderPair_owed_rewards = md_ProviderPair.Fields().ByName("owed_rewards")
	fd_ProviderPair_balances = md_ProviderPair.Fields().ByName("balances")
	fd_ProviderPair_pool_id_to_idx = md_ProviderPair.Fields().ByName("pool_id_to_idx")
	fd_ProviderPair_last_deposit_time = md_ProviderPair.Fields().ByName("last_deposit_time")
}
...
func (x *fastReflection_ProviderPair) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mantrachain.rewards.v1beta1.ProviderPair.pair_id":
		return x.PairId != uint64(0)
	case "mantrachain.rewards.v1beta1.ProviderPair.last_claimed_snapshot_id":
		return x.LastClaimedSnapshotId != uint64(0)
	case "mantrachain.rewards.v1beta1.ProviderPair.owed_rewards":
		return len(x.OwedRewards) != 0
	case "mantrachain.rewards.v1beta1.ProviderPair.balances":
		return len(x.Balances) != 0
	case "mantrachain.rewards.v1beta1.ProviderPair.pool_id_to_idx":
		return len(x.PoolIdToIdx) != 0
	case "mantrachain.rewards.v1beta1.ProviderPair.last_deposit_time":
...
func (x *fastReflection_ProviderPair) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mantrachain.rewards.v1beta1.ProviderPair.pair_id":
		panic(fmt.Errorf("field pair_id of message mantrachain.rewards.v1beta1.ProviderPair is not mutable"))
	case "mantrachain.rewards.v1beta1.ProviderPair.last_claimed_snapshot_id":
		panic(fmt.Errorf("field last_claimed_snapshot_id of message mantrachain.rewards.v1beta1.ProviderPair is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mantrachain.rewards.v1beta1.ProviderPair"))
		}
...
var (
	...
	fd_SnapshotPool_pool_id           protoreflect.FieldDescriptor
	fd_SnapshotPool_coin_supply       protoreflect.FieldDescriptor
	fd_SnapshotPool_rewards_per_token protoreflect.FieldDescriptor
)

func init() {
	file_mantrachain_rewards_v1beta1_common_proto_init()
	md_SnapshotPool = File_mantrachain_rewards_v1beta1_common_proto.Messages().ByName("SnapshotPool")
	fd_SnapshotPool_pool_id = md_SnapshotPool.Fields().ByName("pool_id")
	fd_SnapshotPool_coin_supply = md_SnapshotPool.Fields().ByName("coin_supply")
	fd_SnapshotPool_rewards_per_token = md_SnapshotPool.Fields().ByName("rewards_per_token")
}
...
func (x *fastReflection_SnapshotPool) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "mantrachain.rewards.v1beta1.SnapshotPool.pool_id":
		return x.PoolId != uint64(0)
	case "mantrachain.rewards.v1beta1.SnapshotPool.coin_supply":
		return x.CoinSupply != ""
	case "mantrachain.rewards.v1beta1.SnapshotPool.rewards_per_token":
...
func (x *fastReflection_SnapshotPool) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "mantrachain.rewards.v1beta1.SnapshotPool.rewards_per_token":
		...
		return protoreflect.ValueOfList(value)
	case "mantrachain.rewards.v1beta1.SnapshotPool.pool_id":
		panic(fmt.Errorf("field pool_id of message mantrachain.rewards.v1beta1.SnapshotPool is not mutable"))
	case "mantrachain.rewards.v1beta1.SnapshotPool.coin_supply":
		panic(fmt.Errorf("field coin_supply of message mantrachain.rewards.v1beta1.SnapshotPool is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: mantrachain.rewards.v1beta1.SnapshotPool"))
		}
...
type ProviderPair struct {
	...
	LastClaimedSnapshotId uint64                 `protobuf:"varint,2,opt,name=last_claimed_snapshot_id,json=lastClaimedSnapshotId,proto3" json:"last_claimed_snapshot_id,omitempty"`
	OwedRewards           []*v1beta1.DecCoin     `protobuf:"bytes,3,rep,name=owed_rewards,json=owedRewards,proto3" json:"owed_rewards,omitempty"`
	Balances              []*v1beta1.Coin        `protobuf:"bytes,4,rep,name=balances,proto3" json:"balances,omitempty"`
	PoolIdToIdx           map[uint64]uint64      `protobuf:"bytes,5,rep,name=pool_id_to_idx,json=poolIdToIdx,proto3" json:"pool_id_to_idx,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	LastDepositTime       *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=last_deposit_time,json=lastDepositTime,proto3" json:"last_deposit_time,omitempty"`
}
...
type SnapshotPool struct {
	...
	CoinSupply      string             `protobuf:"bytes,2,opt,name=coin_supply,json=coinSupply,proto3" json:"coin_supply,omitempty"`
	RewardsPerToken []*v1beta1.DecCoin `protobuf:"bytes,3,rep,name=rewards_per_token,json=rewardsPerToken,proto3" json:"rewards_per_token,omitempty"`
}
...
var file_mantrachain_rewards_v1beta1_common_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x31, 0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb8,
	...
	0x52, 0x06, 0x70, 0x61, 0x69, 0x72, 0x49, 0x64, 0x12, 0x37, 0x0a, 0x18, 0x6c, 0x61, 0x73, 0x74,
	0x5f, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f,
	0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x15, 0x6c, 0x61, 0x73, 0x74,
	0x43, 0x6c, 0x61, 0x69, 0x6d, 0x65, 0x64, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x49,
	0x64, 0x12, 0x74, 0x0a, 0x0c, 0x6f, 0x77, 0x65, 0x64, 0x5f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64,
	...
	0x73, 0x2e, 0x44, 0x65, 0x63, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x0b, 0x6f, 0x77, 0x65, 0x64,
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x67, 0x0a, 0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x12, 0x5f, 0x0a, 0x0e, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x69, 0x64, 0x5f, 0x74, 0x6f, 0x5f, 0x69,
	0x64, 0x78, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x6d, 0x61, 0x6e, 0x74, 0x72,
	...
	0x61, 0x69, 0x72, 0x2e, 0x50, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x54, 0x6f, 0x49, 0x64, 0x78, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x70, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x54, 0x6f, 0x49, 0x64,
	0x78, 0x12, 0x50, 0x0a, 0x11, 0x6c, 0x61, 0x73, 0x74, 0x5f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69,
	...
	0x1f, 0x01, 0x52, 0x0f, 0x6c, 0x61, 0x73, 0x74, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x54,
	0x69, 0x6d, 0x65, 0x1a, 0x3e, 0x0a, 0x10, 0x50, 0x6f, 0x6f, 0x6c, 0x49, 0x64, 0x54, 0x6f, 0x49,
	0x64, 0x78, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	...
	,
	...
	0x65, 0x63, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x0f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73,
	0x50, 0x65, 0x72, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x3a, 0x04, 0x88, 0xa0, 0x1f, 0x00, 0x42, 0xfd,
	0x01, 0xa8, 0xe2, 0x1e, 0x01, 0x0a, 0x1f, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x61, 0x6e, 0x74, 0x72,
	0x61, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x2e, 0x76,
	...
	0x74, 0x61, 0x31, 0x3b, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x76, 0x31, 0x62, 0x65, 0x74,
	0x61, 0x31, 0xa2, 0x02, 0x03, 0x4d, 0x52, 0x58, 0xaa, 0x02, 0x1b, 0x4d, 0x61, 0x6e, 0x74, 0x72,
	0x61, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x2e, 0x56,
	...
	0x1d, 0x4d, 0x61, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x3a, 0x3a, 0x52, 0x65,
	0x77, 0x61, 0x72, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x62, 0x06,
...
var file_mantrachain_rewards_v1beta1_common_proto_depIdxs = []int32{
	3, // 0: mantrachain.rewards.v1beta1.ProviderPair.owed_rewards:type_name -> cosmos.base.v1beta1.DecCoin
	4, // 1: mantrachain.rewards.v1beta1.ProviderPair.balances:type_name -> cosmos.base.v1beta1.Coin
	2, // 2: mantrachain.rewards.v1beta1.ProviderPair.pool_id_to_idx:type_name -> mantrachain.rewards.v1beta1.ProviderPair.PoolIdToIdxEntry
	5, // 3: mantrachain.rewards.v1beta1.ProviderPair.last_deposit_time:type_name -> google.protobuf.Timestamp
	3, // 4: mantrachain.rewards.v1beta1.SnapshotPool.rewards_per_token:type_name -> cosmos.base.v1beta1.DecCoin
